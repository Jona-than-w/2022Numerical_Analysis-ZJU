...
int main(){
    ...
    std::cout << "(Bisection Method) The depth of water is " << ans1 << std::endl;
    BisectionSolver sol2(f, 0, 1, eps, eps, 100);
    double ans2 = sol2.solve();
    std::cout <<"(Newton Method) The depth of water is " << ans2 << std::endl;
    SecantSolver sol3(f, 0, 0.5, eps, eps, 100);
    double ans3 = sol3.solve();
    std::cout << "(Secant Method) The depth of water is " << ans3 << std::endl;
    return 0;
}